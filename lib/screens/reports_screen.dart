...
class _ReportsScreenState extends State<ReportsScreen> {
  ...
  void _filterReceipts() {
    ...
    if (filters.isNotEmpty) {
      providerFilteredReceipts = savedReceipts.where((receipt) {
        ...
        // Amount filter - Fixed to properly handle min and max amounts
    ...
    if (searchQuery.isEmpty) {
      ...
      _filteredReceipts = timeFilteredReceipts.where((receipt) {
        ...
        // Search directly in category string
  ...
  // Fixed the missing _buildTimeFilterTab method
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    // Show active amount filter if present
                    Consumer<ReceiptProvider>(
                      builder: (context, provider, child) {
                        ...
                        if ((minAmount != null && minAmount.isNotEmpty) ||
                            (maxAmount != null && maxAmount.isNotEmpty)) {
                          String filterText = '';
                          if (minAmount != null &&
                              minAmount.isNotEmpty &&
                              maxAmount != null &&
                              maxAmount.isNotEmpty) {
                            filterText =
                            '$currencySymbol$minAmount - $currencySymbol$maxAmount';
                          } else if (minAmount != null &&
                              minAmount.isNotEmpty) {
                            filterText = 'Min: $currencySymbol$minAmount';
                          } else if (maxAmount != null &&
                              maxAmount.isNotEmpty) {
                            filterText = 'Max: $currencySymbol$maxAmount';
                          }
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  const SizedBox(width: 8),
                                  // Add cross button to clear amount filter
                                  InkWell(
                                    onTap: () {
                                      provider.updateFilter('minAmount', null);
                                      provider.updateFilter('maxAmount', null);
                                      _filterReceipts();
                                    },
                                    child: Container(
                                      padding: const EdgeInsets.all(4),
                      ...
                      child: _isLoading
                        ...
                        child: ListView.builder(
                          ...
                          padding: const EdgeInsets.only(
                            ...
                            right: 16,
                            bottom:
                            16, // Add bottom padding for system navigation
                          ),
