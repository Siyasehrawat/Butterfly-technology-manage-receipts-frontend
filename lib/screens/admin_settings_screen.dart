...
class _AdminSettingsScreenState extends State<AdminSettingsScreen> {
  ...
  // Currency options
  final List<String> _currencyOptions = ['USD', 'EUR', 'GBP', 'CAD', 'AUD', 'INR'];

  // Date format options
  final List<String> _dateFormatOptions = ['MM-DD-YYYY', 'DD-MM-YYYY', 'YYYY-MM-DD'];
  ...
  Future<void> _fetchSettings() async {
    ...
    try {
      ...
      final url = Uri.parse('https://manage-receipt-backend-bnl1.onrender.com/api/admin/settings');
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          _settings = {
            ...
            'supportEmail': 'support@receiptmanager.com',
  ...
  void _updateFormValues() {
    _appNameController.text = _settings['appName'] ?? 'Receipt Manager';
    _supportEmailController.text = _settings['supportEmail'] ?? 'support@receiptmanager.com';
    _supportPhoneController.text = _settings['supportPhone'] ?? '+1 (555) 123-4567';
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SwitchListTile(
                              ...
                              subtitle: const Text('Automatically categorize receipts'),
