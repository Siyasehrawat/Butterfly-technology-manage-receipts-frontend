...
class _AdminReceiptsScreenState extends State<AdminReceiptsScreen> {
  ...
  Future<void> _fetchReceipts() async {
    ...
    try {
      final url = Uri.parse('https://manage-receipt-backend-bnl1.onrender.com/api/admin/receipts');
      ...
      if (response.statusCode == 200) {
        ...
        final List<dynamic> receiptsData = data['receipts'] ?? data ?? [];
  ...
  Future<void> _deleteReceipt(String receiptId) async {
    try {
      final url = Uri.parse('https://manage-receipt-backend-bnl1.onrender.com/api/admin/receipts/$receiptId');
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text('Are you sure you want to delete the receipt from $merchant?'),
          actions: [
            TextButton(
  ...
  Widget _buildReceiptCard(Map<String, dynamic> receipt) {
    ...
    final receiptId = receipt['id']?.toString() ?? receipt['imageId']?.toString() ?? '';
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Expanded(
                  child: _buildInfoChip('Date', formattedDate, Icons.date_range),
                ),
              ],
            ),
