...
class _AdminUsersScreenState extends State<AdminUsersScreen> {
  ...
  Future<void> _fetchUsers() async {
    ...
    try {
      final url = Uri.parse('https://manage-receipt-backend-bnl1.onrender.com/api/admin/users');
      ...
      if (response.statusCode == 200) {
        ...
        final List<dynamic> usersList = data['users'] ?? data ?? [];
  ...
  Future<void> _deleteUser(String userId) async {
    try {
      final url = Uri.parse('https://manage-receipt-backend-bnl1.onrender.com/api/admin/users/$userId');
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              flex: 2,
                              child: _buildSortableHeader('Receipts', 'receiptsCount'),
                            ),
      ...
      child: Row(
        children: [
          Text(
            title,
            style: TextStyle(
              fontWeight: isCurrentSortField ? FontWeight.bold : FontWeight.normal,
              color: isCurrentSortField ? const Color(0xFF7E5EFD) : Colors.black,
            ),
          ),
  ...
  void _toggleUserStatus(Map<String, dynamic> user) {
    ...
    final action = user['status'] == 'Active' ? 'deactivated' : 'activated';

    showDialog(
      context: context,
      builder: (context) {
        return AlertDialog(
          title: Text('${user['status'] == 'Active' ? 'Deactivate' : 'Activate'} User'),
          content: Text('Are you sure you want to ${user['status'] == 'Active' ? 'deactivate' : 'activate'} ${user['name']}?'),
          actions: [
            TextButton(
              onPressed: () => Navigator.pop(context),
              child: const Text('Cancel'),
