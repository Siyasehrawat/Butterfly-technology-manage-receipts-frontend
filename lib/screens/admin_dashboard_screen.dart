...
class _AdminDashboardScreenState extends State<AdminDashboardScreen> {
  ...
  Future<void> _fetchDashboardData() async {
    ...
    try {
      final url = Uri.parse('https://manage-receipt-backend-bnl1.onrender.com/api/admin/summary');
  ...
  Widget _buildTopCategoriesSection() {
    final topCategories = _dashboardData['topCategories'] as List<dynamic>? ?? [];
        ...
        children: [
          ...
          if (topCategories.isEmpty)
            ...
            ...topCategories.map<Widget>((category) {
              ...
              final total = _dashboardData['totalReceipts'] as int? ?? 1;
