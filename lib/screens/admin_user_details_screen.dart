...
class _AdminUserDetailsScreenState extends State<AdminUserDetailsScreen> {
  ...
  Future<void> _fetchUserDetails() async {
    ...
    try {
      ...
      final url = Uri.parse('https://manage-receipt-backend-bnl1.onrender.com/api/admin/users/${widget.userId}');
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          _userReceipts = List<Map<String, dynamic>>.from(data['receipts'] ?? []);
          _isLoading = false;
        });
      } else {
        ...
        setState(() {
          _userDetails = {
            ...
            'lastLogin': DateTime.now().subtract(const Duration(days: 2)).toIso8601String(),
          };

          _userReceipts = List.generate(
            10,
                (index) => {
              'id': 'receipt_$index',
              'merchant': 'Merchant ${index + 1}',
              'amount': (index + 1) * 10.99,
              'date': DateTime.now().subtract(Duration(days: index * 3)).toIso8601String(),
              'category': index % 5 == 0
                  ? 'Shopping'
                  : index % 4 == 0
                  ? 'Food'
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _buildInfoRow(
                              'Joined',
                              _formatDate(_userDetails['createdAt']),
                            ...
                            _buildInfoRow(
                              'Last Login',
                              _formatDate(_userDetails['lastLogin']),
                              Icons.login,
                            ),
                            const Divider(),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _userReceipts.isEmpty
                              ...
                              itemCount: _userReceipts.length > 5 ? 5 : _userReceipts.length,
  ...
  void _showEditUserDialog() {
    ...
    final addressController = TextEditingController(text: _userDetails['address']);
