...
import 'providers/setting_provider.dart'; // Import from providers folder
...
import 'screens/settings_screen.dart'; // Import from screens folder
...
void main() {
  ...
  SystemChrome.setSystemUIOverlayStyle(const SystemUiOverlayStyle(
    ...
    statusBarBrightness: Brightness.light, // for iOS (light content = dark status bar)
